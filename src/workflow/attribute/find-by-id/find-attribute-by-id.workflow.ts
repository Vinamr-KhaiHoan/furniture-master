...
export interface IFindAttributeByIdWorkflow extends IFindByIdWorkflow<AttributeDomain, IFindAttributeByIdInput, IFindAttributeByIdOutput> {}

@singletonNamedProvide(TYPES.WORKFLOW, ATTRIBUTE_WORKFLOW.FIND_BY_ID)
export class FindAttributeByIdWorkflow extends FindByIdWorkflow<AttributeDomain, IFindAttributeByIdInput, IFindAttributeByIdOutput> {
    get DOMAIN() {
