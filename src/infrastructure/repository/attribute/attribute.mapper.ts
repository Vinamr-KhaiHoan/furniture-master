...
export interface IAttributeMapper extends IDataMapper<AttributeDomain> { }

@singletonNamedProvide(TYPES.MAPPER, API_DOMAIN.ATTRIBUTE)
export class AttributeMapper extends BaseDatabMapper<AttributeDomain> implements IAttributeMapper {
